...
function initTerrain(){
	...
	terrainScene = THREE.Terrain({
	    ...
	    material: new THREE.MeshPhongMaterial({color: 0x5566aa}),
	    maxHeight: 100,
	    minHeight: -100,
	    steps: 1,
	...
	loader.load('lib/js/three/examples/textures/terrain/grasslight-big.jpg', function(t2){
		t2.wrapS = t2.wrapT = THREE.RepeatWrapping;
		loader.load('lib/js/three/examples/textures/terrain/backgrounddetailed6.jpg', function(t3){
			t3.wrapS = t3.wrapT = THREE.RepeatWrapping;
			blend = THREE.Terrain.generateBlendedMaterial([
				{texture: t1, levels: [-80, -35, 20, 50]},
