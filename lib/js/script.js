...
function initBase(){
	...
	enSelected.push(new THREE.Mesh(
		...
		new THREE.MeshPhongMaterial({
			color: parseInt(modelEnnemy.ennemies[0].color),
			wireframe: false
		})));
	enSelected.push(new THREE.Mesh(
		new THREE.BoxBufferGeometry(ennemy_large_x, ennemy_large_y, ennemy_large_z),
		new THREE.MeshPhongMaterial({
			color: parseInt(modelEnnemy.ennemies[8].color),
			wireframe: false
		})));
	enSelected.push(new THREE.Mesh(
		new THREE.BoxBufferGeometry(ennemy_large_x, ennemy_large_y, ennemy_large_z),
	...
	enSelected[2].text = "<h1>Super sbire</h1> appears on level 3 </br> HP: 3 </br> Points:3 </br> Apparition : 19%";
	enSelected[3].text = "<h1>Mini boss</h1> appears on level 4 </br> HP: 5 </br> Points: 10 </br> Apparition : 11%";
	enSelected[4].text = "<h1>Boss</h1> appears on level 5 </br> HP: 10 </br> Points: 100 </br> Apparition : 4%"
 	for(var o =0; o<enSelected.length;o++){
		scene.add(enSelected[o]);
	}
	enSelected[0].position.set(1,0,-2);
